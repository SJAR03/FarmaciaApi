...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1",
        ...
        { 
            Title = "Farmacia API", 
            Version = "v1",
            Description = "Esta es la API encargada de toda la logica del backend´para el proyecto de Ingenieria de software"
        });
    ...
    // Configuracion de autenticacion JWT para swagger
